...
export const AdvisorModal: React.FC<AdvisorModalProps> = ({ isOpen, onClose, context }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white rounded-sm shadow-2xl w-full max-w-lg overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200">
                ...
                {/* Body */}
                <div className="p-6">
                    <div className={`${content.introBg} border rounded-sm p-4 mb-6 transition-colors duration-300`}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 border border-slate-300 rounded-sm focus:ring-2 focus:ring-${content.accentColor}-500 focus:border-${content.accentColor}-500 outline-none transition`}
                                    value={postcode}
                        ...
                        <button
                            ...
                            className={`w-full bg-${content.accentColor}-600 hover:bg-${content.accentColor}-700 text-white font-bold py-3 rounded-sm flex items-center justify-center gap-2 transition-all transform hover:scale-[1.02]`}
                        >
