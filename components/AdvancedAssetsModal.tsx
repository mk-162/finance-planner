        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white rounded-sm shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto">
                    ...
                    {activeTab === 'property' ? (
                        <>
                            <div className="bg-blue-50/50 p-4 rounded-sm mb-6 border border-blue-100">
                        ...
                        <>
                            ...
                            <div className="space-y-2">
                                ...
                                {dbPensions.map(d => (
                                    <div key={d.id} className="flex items-center justify-between p-3 bg-white border border-slate-200 rounded-sm shadow-sm">
                                        <div>
